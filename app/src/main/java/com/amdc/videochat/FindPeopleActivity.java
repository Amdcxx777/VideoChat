    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchET.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence charSeq, int start, int before, int count) {
                if (searchET.getText().toString().equals("")) Toast.makeText(FindPeopleActivity.this, "Please write name to search.", Toast.LENGTH_SHORT).show();
                else str = charSeq.toString();
                onStart();
            }
            @Override
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Contacts, FindFriendsViewHolder> firebaseRecyclerAdapter
            ...
            protected void onBindViewHolder(@NonNull FindFriendsViewHolder holder, final int position, @NonNull Contacts model) {
                ...
                Picasso.get().load(model.getImage()).resize(250, 300).into(holder.profileImageView);
